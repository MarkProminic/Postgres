...
ALTER TABLE pg_config OWNER TO postgres;
...
--
-- Name: ps_config id; Type: DEFAULT; Schema: public; Owner: asterisk_role
--

ALTER TABLE ONLY ps_config ALTER COLUMN id SET DEFAULT nextval('ps_config_id_seq'::regclass);


SET search_path = pg_catalog;

--
-- Data for Name: pg_ts_config; Type: TABLE DATA; Schema: pg_catalog; Owner: postgres
--

COPY pg_ts_config (cfgname, cfgnamespace, cfgowner, cfgparser) FROM stdin;
simple	11	10	3722
danish	11	10	3722
dutch	11	10	3722
english	11	10	3722
...
1030	prominic	type	user	\N	ari.conf	0	\N
1031	prominic	read_only	no	\N	ari.conf	0	\N
...
17	prominic	secret	password	\N	manager.conf	0	\N
18	prominic	deny	0.0.0.0/0.0.0.0	\N	manager.conf	0	\N
19	prominic	permit	0.0.0.0/0.0.0.0	\N	manager.conf	0	\N
20	prominic	read	system,call,log,verbose,command,agent,user,config,dtmf,reporting,cdr,dialplan,originate	\N	manager.conf	0	\N
22	prominic	writetimeout	100	\N	manager.conf	0	\N
...
1094	prominic	type	ical	\N	calendar.conf	0	\N
1095	prominic	url	https://dontknowwheretogo	\N	calendar.conf	0	\N
21	prominic	write	all	\N	manager.conf	0	\N
1096	prominic	user	asteriskserver	\N	calendar.conf	0	\N
1097	prominic	secret	password	\N	calendar.conf	0	\N
1098	prominic	refresh	15	\N	calendar.conf	0	\N
1099	prominic	timeframe	60	\N	calendar.conf	0	\N
...
1032	prominic	password_format	plain	\N	ari.conf	0	\N
1033	prominic	password	password	\N	ari.conf	0	\N
1100	prominic	''	''	\N	pjsip_wizard.conf	0	\N
...
1101	prominic-dialer	write	originate	\N	manager.conf	0	\N
1102	prominic-dialer	secret	password	\N	manager.conf	0	\N
1103	prominic-dialer	deny	0.0.0.0/0.0.0.0	\N	manager.conf	0	\N
1104	prominic-dialer	permit	0.0.0.0/0.0.0.0	\N	manager.conf	0	\N
1105	prominic-dialer	read	originate	\N	manager.conf	0	\N
1106	prominic-dialer	writetimeout	100	\N	manager.conf	0	\N
...
1107	applicationmap	putonhold	#2,peer,ControlPlayback,"moh/Prominic/wav_MOH_Prominic,10,#,*,#3"	\N	features.conf	0	\N
1109	applicationmap	takeoffhold	#3,peer,SendDTMF,"#3,250,140"	\N	features.conf	0	\N
...
2	general	servername	host-1096.pbx.prominic.net	\N	http.conf	0	\N
...
COPY interface_config (id, category, property, value) FROM stdin;
1	voicemail	base_directory	/switchboard/voicemail
2	recording	base_directory	/switchboard/recordings/
3	dialer	international_dial_out_code	011
4	dialplan	internal_context	agents
5	dialplan	trunk_context	from-peer
7	dialplan	agent_dest_appdata	agents,AGENTID,1
6	dialplan	queue_dest_appdata	queues,QUEUENAME,1
11	voicemail	folders	INBOX,Old,DELETED
12	voicemail	display_folders	INBOX,Old
15	voicemail	email_host	MISSING_VALUE
16	mail	outbound_mail_host	MISSING_VALUE
14	mail	from_address	PhoneInterface@prominic.net
13	mail	call_record_report_receipients	MISSING_VALUE
8	dialer	dial_out_trunk	MISSING_VALUE
19	call_record	ignore_list	\N;
\.
...
43	general	callerid	\N	\N	sip.conf	0	\N
...
6	general	serveremail	voicemail@pbx.prominic.net	\N	voicemail.conf	0	\N
...
56	general	fromstring	voicemail@pbx.prominic.net	\N	voicemail.conf	0	\N
